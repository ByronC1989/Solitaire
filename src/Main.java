public class Main {
        public static void main(String[] args) {
                ...
                // System.out.println("Cards remaining in deck after initializing the Tableau: "
                // + deck.deckSize());
                //
                // System.out.println("\nStockPile:");
                ...
                // System.out.println("\nDeck contains: " + deck.deckSize() + " cards after
                // drawing for tableau");
                //
                // System.out.println("\nPrinting tableau's with the correct number of cards per
                // column\n");
                // tableau.printTableau();
                //
                // System.out.println("\n\nDrawing a card from the deck!");
                // // System.out.println(testCard + " was drawn from the deck!");
                // System.out.println("Deck contains: " + deck.deckSize() + " cards after
                // drawing a card!");
                //
                // // Foundation demo
                // Foundation foundation = new Foundation();
                ...
                // System.out.println("\nAttempting to add " + cardDemo + " to first empty
                // tableau!");
